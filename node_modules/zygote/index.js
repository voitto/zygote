...
var server = http.createServer( function( req, res ) {
  ...
  f = routes[ req.url + req.method.toLowerCase() ];
...
Model.prototype.create = function( data ) {
  var client = new pg.Client('postgres://'+prefs['dbuser']+':@'+prefs['dbhost']+':'+prefs['dbhost']+'/'+prefs['dbname']);
  var model = this;
  client.on('drain', client.end.bind(client));
  client.connect();
  var ins_query = client.query({
    text: 'INSERT INTO post VALUES ($1)',
    values: [data.title]
  });
...
Model.prototype.find = function() {
  ...
  var model = this;
  var rows = [];
  var client = new pg.Client('postgres://'+prefs['dbuser']+':@'+prefs['dbhost']+':'+prefs['dbport']+'/'+prefs['dbname']);
  client.on('drain', client.end.bind(client));
  client.connect();
...
get('/post.json', function(req,res){
  var response = res;
  var rows = [];
  var client = new pg.Client('postgres://'+prefs['dbuser']+':@localhost:5432/'+prefs['dbname']);
  client.on('drain', client.end.bind(client));
  client.connect();
  var query = client.query({
